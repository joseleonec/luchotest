# mscuentas - Spring Boot Application
...
2. Create a database named `mscuentasdb`.
...
-   **File**: `src/main/resources/mscuentas-sofka.postman_collection.json`
...
```bash
# Build
docker build -t joseleon97/mscuentas:latest .

# Run
docker run -p 8080:8080 \
  -e SPRING_DATASOURCE_URL=jdbc:postgresql://host.docker.internal:5432/mscuentasdb \
